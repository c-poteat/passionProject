...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAVORITERECIPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_FAVORITERECIPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FAVORITERECIPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FAVORITERECIPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FAVORITERECIPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FAVORITERECIPES actions', async () => {
      const expectedActions = [
        {
