...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROCERYITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROCERYITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROCERYITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROCERYITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROCERYITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROCERYITEM actions', async () => {
      const expectedActions = [
        {
